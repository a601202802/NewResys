...
function InitiateSideMenu() {
    ...
    $("#sidebar-collapse").on("click", function () {
        ...
        $(".sidebar-collapse").toggleClass("active"); n = $("#sidebar").hasClass("menu-compact"); n && $(".open > .submenu").removeClass("open")
        ...
        var i = $(t.target).closest("a"), u, r, f; if (i && i.length != 0)
        {
            ...
            if (r = i.next().get(0), !$(r).is(":visible")) {
               // if (f = $(r.parentNode).closest("ul"), n && f.hasClass("sidebar-menu"))
                 //   return; f.find("> .open > .submenu").each(function () { this == r || $(this.parentNode).hasClass("active") || $(this).slideUp(200).parent().removeClass("open") })
