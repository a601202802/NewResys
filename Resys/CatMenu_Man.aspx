<%@ Page Language="C#" MasterPageFile="~/User.master" AutoEventWireup="true" CodeFile="CatMenu_Man.aspx.cs" Inherits="CatMenu_Man" %>

<%@ Register TagPrefix="UserControl" TagName="CatMenu_Man1" Src="~/CatMenu_Man1.ascx" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div id="CurrentPosition">当前位置：<a href="Cat_Man.aspx">菜单管理</a></div>
    <div class="page-body">
        <div class="row">
            <div class="col-xs-12 col-md-12">
                <div class="widget">
                    ...
                    <div class="widget-body">
                        ...
                        <div align="left">
                            <asp:Button ID="CatMenuAdd" runat="server" Text="新增一级菜单" Height="32px" class="btn btn-info" OnClick="Button3_Click" />&nbsp;&nbsp;&nbsp;
                            <asp:Button ID="SubMenuAdd" runat="server" Text="新增二级菜单" Height="32px" class="btn btn-info" OnClick="Button4_Click" />&nbsp;&nbsp;&nbsp;
                        </div>
                        <!-- 显示主栏目列表 -->
                                ...
                                <ItemTemplate>
                                    <div class="Cat">
                                        ...
                                        <div style="float: right; margin-top: -30px;margin-bottom:8px; margin-right:29px;">
                                            ...
                                            <a href='CatMenu_Edit.aspx?ID=<%# Eval("ID") %>' class="btn btn-info">编辑</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                            <a href='CatMenu_Del.aspx?ID=<%# Eval("ID") %>' class="btn btn-danger">删除</a>
                                        </div>
                                        <div>
